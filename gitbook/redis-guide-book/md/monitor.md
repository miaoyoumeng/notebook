...
> ，**可视化监控工具** ，以及**Redis监控体系** 等方面帮助你构建对redis运维/监控体系的认知，它是性能优化的前提。@pdai
...
![](/images/db/redis/redis-stat-1.png)

和web模式

![](/images/db/redis/redis-stat-2.png)
...
![](/images/db/redis/redis-live-1.png)
...
![](/images/db/redis/redis-redmon-1.png)

cli

![](/images/db/redis/redis-redmon-2.png)

动态更新配置

![](/images/db/redis/redis-redmon-3.png)
...
![](/images/db/redis/redis-export-1.png)

![](/images/db/redis/redis-export-2.png)
...
![](/images/db/redis/db-redis-monitor-2.png)
