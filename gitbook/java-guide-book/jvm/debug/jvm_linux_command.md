...
> Java 在线问题排查主要分两篇：本文是第一篇，通过linux常用命令排查。@pdai
...
更多请参考：[Linux sed 命令在新窗口打开](https://www.runoob.com/linux/linux-comm-sed.html)
或者 [Linux sed命令详解在新窗口打开](https://www.cnblogs.com/ftl1012/p/9250171.html)
...
netstat 请参考这篇文章: [Linux
netstat命令详解在新窗口打开](https://www.cnblogs.com/ftl1012/p/netstat.html)
...
tsar是淘宝开源的的采集工具。很好用,
将历史收集到的数据持久化在磁盘上，所以我们快速来查询历史的系统数据。当然实时的应用情况也是可以查询的啦。大部分机器上都有安装。
...
具体可以看这篇文章：[linux 淘宝开源监控工具tsar在新窗口打开](https://www.jianshu.com/p/5562854ed901)
