...
![image](../imgs/db-mysql-sql-parser-1.png)
...
![image](../imgs/db-mysql-sql-parser-2.png)
...
![image](../imgs/db-mysql-sql-parser-5.png)

b）1=2 and (m > 3 and n > 4)

![image](../imgs/db-mysql-sql-parser-6.png)

c）1=1 or (m > 3 and n > 4)

![image](../imgs/db-mysql-sql-parser-7.png)

d）1=2 or (m > 3 and n > 4)

![image](../imgs/db-mysql-sql-parser-8.png)
