...
description: 根据当前 branch 与目标 branch 的差异，自动生成 Pull Request 的 Title 与 Description。当用户提到「PR」、「Pull Request」、「写 PR」、「PR 描述」、「PR description」、「建立 PR」时触发此 Skill。
---
