...
**子项目**： 保存路径如下，提供后续方案。
- web-manager: 保存到 `/ui/web-manager/YYYY-MM-DD-<topic>-prd.html`
- web-pc: 保存到 `/ui/web-pc/YYYY-MM-DD-<topic>-prd.html`
- web-m: 保存到 `/ui/web-m/YYYY-MM-DD-<topic>-prd.html`
- app: 保存到 `/ui/app/YYYY-MM-DD-<topic>-prd.html`
- wechat: 保存到 `/ui/wechat/YYYY-MM-DD-<topic>-prd.html`
