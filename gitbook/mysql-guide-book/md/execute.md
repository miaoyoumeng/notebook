...
自己能认识的语言，具体可以看[MySQL - MySQL中SQL是如何解析的](/md/db/sql-mysql/sql-mysql-sql-
parser.html)。

![](../imgs/db-mysql-sql-6.png)
