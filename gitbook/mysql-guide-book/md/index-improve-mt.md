...
> 优化的目的，索引优化往往可以在短时间内产生非常巨大的效果。本文旨在以开发工程师的角度来解释数据库索引的原理和如何优化慢查询。@pdai
...
![image](../imgs/db-mysql-index-improve-mt-1.png)
...
![image](../imgs/db-mysql-index-improve-mt-2.png)
