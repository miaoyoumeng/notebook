...
![](../../imgs/concurrent/java-hash-table-demo-code.png)
...
![](../../imgs/concurrent/java-concurrent-hash-map-class-diagrams.png)

ConcurrentHashMap是由Segment数组结构和HashEntry数组结构组成。Segment是一种可重入锁ReentrantLock，在ConcurrentHashMap里扮演锁的角色，HashEntry则用于存储键值对数据。一个ConcurrentHashMap里包含一个Segment数组，Segment的结构和HashMap类似，是一种数组和链表结构， 一个Segment里包含一个HashEntry数组，每个HashEntry是一个链表结构的元素， 每个Segment守护者一个HashEntry数组里的元素,当对HashEntry数组的数据进行修改时，必须首先获得它对应的Segment锁。

![](../../imgs/concurrent/java-concurrent-hash-map-struts-diagrams.png)
...
![](../../imgs/concurrent/java-concurrent-hash-map-code-1.png)
...
![](../../imgs/concurrent/java-concurrent-hash-map-code-2.png)
...
![](../../imgs/concurrent/java-concurrent-hash-map-code-3.png)
...
![](../../imgs/concurrent/java-concurrent-hash-map-code-4.png)
...
![](../../imgs/concurrent/java-concurrent-hash-map-code-5.png)

可以发现每一位的数据都散列开了，通过这种再哈希能让数字的每一位都能参加到哈希运算当中，从而减少哈希冲突。ConcurrentHashMap通过以下哈希算法定位segment。

![](../../imgs/concurrent/java-concurrent-hash-map-code-6.png)
