...
其它还要考虑啥嗯？借助美团技术团队的一篇文章，[消息队列设计精要在新窗口打开](https://tech.meituan.com/2016/07/01/mq-
design.html) 中的图

![images](../imgs/db-redis-stream-1.png)
...
![images](../imgs/db-redis-stream-2.png)
...
![images](../imgs/db-redis-stream-3.png)
...
![images](../imgs/db-redis-stream-4.png)

客户端可以平滑扩展，提高处理能力

![images](../imgs/db-redis-stream-5.png)
