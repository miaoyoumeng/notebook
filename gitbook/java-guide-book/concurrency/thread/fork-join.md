...
> Conquer)的并行实现，它是一项可以获得良好的并行性能的简单且高效的设计技术。目的是为了帮助我们更好地利用多处理器带来的好处，使用所有可用的运算能力来提升应用的性能。@pdai
...
![](../../imgs/concurrent/java-thread-x-forkjoin-2.png)
...
![](../../imgs/concurrent/java-thread-x-forkjoin-3.png)
...
![](../../imgs/concurrent/java-thread-x-forkjoin-5.png)
...
![](../../imgs/concurrent/java-thread-x-forkjoin-1.png)
...
![](../../imgs/concurrent/java-thread-x-forkjoin-4.png)
...
![](../../imgs/concurrent/java-thread-x-forkjoin-6.png)
