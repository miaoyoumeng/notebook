...
> Redis 发布订阅(pub/sub)是一种消息通信模式：发送者(pub)发送消息，订阅者(sub)接收消息。 @pdai
...
![images](../imgs/db-redis-sub-1.svg)

当有新消息通过 PUBLISH 命令发送给频道 channel1 时， 这个消息就会被发送给订阅它的三个客户端：

![images](../imgs/db-redis-sub-2.svg)
...
![images](../imgs/db-redis-sub-8.png)
...
![images](../imgs/db-redis-sub-3.svg)
...
![images](../imgs/db-redis-sub-4.svg)
...
![images](../imgs/db-redis-sub-9.svg)
...
![images](../imgs/db-redis-sub-10.svg)
