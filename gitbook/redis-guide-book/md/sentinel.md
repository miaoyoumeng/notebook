...
> 主从集群中，哨兵机制是实现主从库自动切换的关键机制，它有效地解决了主从复制模式下故障转移的问题。@pdai
...
![images](../imgs/db-redis-sen-1.png)
...
![images](../imgs/db-redis-sen-6.png)
...
![images](../imgs/db-redis-sen-7.png)
...
![images](../imgs/db-redis-sen-2.png)
...
![images](../imgs/db-redis-sen-3.png)
...
![images](../imgs/db-redis-sen-4.png)
...
![images](../imgs/db-redis-sen-5.png)
